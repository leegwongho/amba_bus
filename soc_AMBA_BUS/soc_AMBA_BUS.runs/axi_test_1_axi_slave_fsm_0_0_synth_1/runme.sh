...
HD_PWD='C:/github/amba_bus/soc_AMBA_BUS/soc_AMBA_BUS.runs/axi_test_1_axi_slave_fsm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_test_1_axi_slave_fsm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_test_1_axi_slave_fsm_0_0.tcl
