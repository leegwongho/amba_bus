...
HD_PWD='C:/github/amba_bus/soc_AMBA_BUS/soc_AMBA_BUS.runs/micro_blaze_AMBA_BUS_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_blaze_AMBA_BUS_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_blaze_AMBA_BUS_rst_clk_wiz_0_100M_0.tcl
