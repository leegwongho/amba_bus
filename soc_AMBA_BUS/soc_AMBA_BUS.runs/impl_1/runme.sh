...
HD_PWD='C:/github/amba_bus/soc_AMBA_BUS/soc_AMBA_BUS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_blaze_AMBA_BUS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source micro_blaze_AMBA_BUS_wrapper.tcl -notrace
