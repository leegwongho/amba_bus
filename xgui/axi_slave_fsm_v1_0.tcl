...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "STATE_READ" -parent ${Page_0}
  ipgui::add_param $IPINST -name "STATE_READ_READY" -parent ${Page_0}
  ipgui::add_param $IPINST -name "STATE_WRITE" -parent ${Page_0}
...
proc update_PARAM_VALUE.STATE_READ { PARAM_VALUE.STATE_READ } {
	# Procedure called to update STATE_READ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STATE_READ { PARAM_VALUE.STATE_READ } {
	# Procedure called to validate STATE_READ
	return true
}
...
proc update_PARAM_VALUE.STATE_WRITE { PARAM_VALUE.STATE_WRITE } {
	# Procedure called to update STATE_WRITE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STATE_WRITE { PARAM_VALUE.STATE_WRITE } {
	# Procedure called to validate STATE_WRITE
	return true
}
...
proc update_MODELPARAM_VALUE.STATE_READ { MODELPARAM_VALUE.STATE_READ PARAM_VALUE.STATE_READ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STATE_READ}] ${MODELPARAM_VALUE.STATE_READ}
}

proc update_MODELPARAM_VALUE.STATE_WRITE { MODELPARAM_VALUE.STATE_WRITE PARAM_VALUE.STATE_WRITE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STATE_WRITE}] ${MODELPARAM_VALUE.STATE_WRITE}
}
